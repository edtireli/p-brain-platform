...
# Set up directories
image_dir = '/Users/edt/Desktop/p-brain/output_pngs_ss'
mask_dir = '/Users/edt/Desktop/p-brain/output_pngs_ss'
batch_size = 10
...
# Set up callbacks
callbacks = [
    ModelCheckpoint('ss_roi_model.keras', save_best_only=True)
]

# Train the model
model.fit(train_sequence, validation_data=val_sequence, epochs=20, callbacks=callbacks)
